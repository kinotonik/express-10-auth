...
usersRouter.post("/", async (req, res) => {
  const { email, firstname, lastname, city, language, password } = req.body;

  let validatePassword = await User.hashPassword(password);
  ...
  User.findByEmail(email)
    .then((existingUserWithEmail) => {
      ...
      validationErrors = User.validate(dataUser);
